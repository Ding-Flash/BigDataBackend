...
def generate_random_parameters(program):
    ...
    shuffleIMR = random.randrange(1, 10, 2)  # spark.shuffle.io.maxRetries   3
    ...
    if program.lower() == 'pagerank':
        ...
        driMem = random.randrange(4, 10, 1)  # spark.driver.memory   1g
        driCor = random.randrange(3, 8, 1)  # spark.driver.cores    1
        exeMem = random.randrange(4, 10, 1)  # spark.executor.memory 1g
        exeCor = random.randrange(3, 8, 1)  # spark.executor.cores
    ...
    driMem = random.randrange(1, 5, 1)  # spark.driver.memory   1g
    driCor = random.randrange(1, 6, 1)  # spark.driver.cores    1
    exeMem = random.randrange(1, 5, 1)  # spark.executor.memory 1g
    exeCor = random.randrange(1, 4, 1)  # spark.executor.cores
